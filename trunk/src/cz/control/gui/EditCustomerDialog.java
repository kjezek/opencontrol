 ...
 *
 * Tøída vytváøí dialogové okno pro editace, nebo zavedení nového odbìratele
 *
 * @author Kamil Ježek
 *
 * (C) 2005, ver. 1.0
...
public class EditCustomerDialog extends JDialog implements WindowListener {
    ...
    private EditCustomerDialog(Frame owner) {
        super(owner, "Editace odbìratele", true);
        this.owner = owner;
        setDialog();
    }
...
//        setLocationByPlatform(true);
        ...
        inputCust = null; // Napøíštì nastav na null
    }    
